    ...
    <section id="problem" className="py-20 relative overflow-hidden">
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[hsl(var(--navy-deep))]/80 backdrop-blur-sm border border-[hsl(var(--cyan-glow))]/30 rounded-2xl p-8 hover:border-[hsl(var(--cyan-glow))]/50 hover:shadow-[0_0_40px_rgba(0,255,255,0.2)] transition-all duration-500 hover:scale-[1.02] animate-fade-in relative overflow-hidden group" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="relative">
              <div className="flex items-start gap-4 mb-6">
                <div className="p-3 bg-[hsl(var(--cyan-glow))]/10 rounded-lg flex-shrink-0 group-hover:bg-[hsl(var(--cyan-glow))]/20 transition-colors">
