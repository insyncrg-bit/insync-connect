        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white">
              The <span className="text-blue-300 inline-block hover:scale-110 transition-transform duration-300">Noise Problem</span>
            </h2>
          ...
          <div className="bg-[hsl(var(--navy-deep))]/80 backdrop-blur-sm border border-blue-400/20 rounded-2xl p-8 hover:border-blue-400/30 hover:shadow-[0_0_30px_rgba(96,165,250,0.15)] transition-all duration-500 hover:scale-[1.02] animate-fade-in relative overflow-hidden group" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="relative">
              <div className="flex items-start gap-4 mb-6">
                <div className="p-3 bg-blue-400/10 rounded-lg flex-shrink-0 group-hover:bg-blue-400/15 transition-colors">
