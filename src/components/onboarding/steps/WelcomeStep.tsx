...
export const WelcomeStep = ({
  ...
  <div className="space-y-6">
    <div className="text-center space-y-4">
      ...
      <h2 className="text-2xl font-bold text-[hsl(var(--navy-deep))]">{title}</h2>
      <p className="text-[hsl(var(--navy-deep))]/60 max-w-md mx-auto">{description}</p>
    </div>
    <div className="space-y-4 pt-4">
      <div className="bg-[hsl(var(--cyan-glow))]/5 border border-[hsl(var(--cyan-glow))]/20 rounded-lg p-4">
        <h3 className="text-[hsl(var(--navy-deep))] font-medium mb-2">What to expect:</h3>
        <ul className="space-y-2 text-sm text-[hsl(var(--navy-deep))]/60">
