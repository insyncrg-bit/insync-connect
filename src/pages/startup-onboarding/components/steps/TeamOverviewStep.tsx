  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-white/60">Tell us about your team and company overview</p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          rows={6}
        />
        <p className={`text-xs ${wordCount >= 30 ? "text-cyan-glow" : "text-white/50"}`}>
          {wordCount} / 30 words
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <Label className="text-white/80">Team Members</Label>
          <Button
            type="button"
            variant="outline"
            size="sm"
          ...
          <div key={index} className="bg-white/5 border border-white/10 rounded-lg p-4 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/80 font-medium">Team Member {index + 1}</span>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label className="text-white/80">Name {index === 0 && "*"}</Label>
                <Input
                  value={member.name}
              ...
              <div className="space-y-2">
                <Label className="text-white/80">Role {index === 0 && "*"}</Label>
                <Input
                  value={member.role}
