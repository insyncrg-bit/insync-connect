...
const Index = () => {
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: 'linear-gradient(180deg, hsl(234 71% 15%) 0%, hsl(210 70% 30%) 25%, hsl(182 62% 45%) 50%, hsl(210 70% 30%) 75%, hsl(234 71% 15%) 100%)' }}>
